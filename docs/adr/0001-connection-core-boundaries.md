...
таймером. Исправленный MIPSel ELF собран и проверен на NC-1913: 14/14
handshake и 2302 mixed probes без ошибок при штатном timeout. Под высокой
нагрузкой DoH достиг 9.325 s с включённым NetLog; это не автоматически принятый
product budget. Digest и ограничения зафиксированы в отчёте #63.
Завершение runtime-исследования не закрывает весь G2.
